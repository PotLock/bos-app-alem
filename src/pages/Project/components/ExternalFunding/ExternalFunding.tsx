...
const ExternalFunding = ({ externalFunding }: any) => {
  ...
  const ArrowDown = (arrowProps: any) => (
    ...
    >
      <path d="M6 0.294983L0 6.29498L1.41 7.70498L6 3.12498L10.59 7.70498L12 6.29498L6 0.294983Z" fill="#151A23" />
    </Arrow>
  );
  ...
  return (
    <Container>
      ...
      >
        ...
        {externalFunding.map(({ investorName, description, date, amountReceived, denomination }: any) => (
