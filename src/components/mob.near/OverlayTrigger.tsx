...
const OverlayTrigger = (props: any) => {
  ...
  const overlayClassName = props.overlayClassName ?? "border m-3 p-3 rounded-4 bg-white shadow";
  ...
  return (
    <OverlayTrigger
      ...
      overlay={overlay}
    >
      <span className="d-inline-flex" onMouseEnter={handleOnMouseEnter} onMouseLeave={handleOnMouseLeave}>
        {props.children}
      </span>
    </OverlayTrigger>
  );
